...
import {  ValidationSchema } from "../types/interface.js";
import { AnyFunction } from "../types/types.js";
import { ExpressCallBackFunction } from "../types/types.js";
...
export const controllerHandler = (controllerFunc: AnyFunction, schema: ValidationSchema | undefined = {}): ExpressCallBackFunction  => {
    return async (req: Request, res: Response, next: NextFunction) => {
        ...
        try{
            ...
            const result = await controllerFunc(controllerArgs);
            console.log(result)
